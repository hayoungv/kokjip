...
> 지금 저장소는 **1단계 웹 데모**입니다. 학습자가 쓰는 것은 안드로이드 앱이며 2단계에서 만듭니다. 웹에서 학습자 화면을 열면 앱에서 보이는 모양 그대로 보이도록 휴대폰 틀 안에 넣어 두었습니다.
...
| 주체 | 화면 | 들어가는 법 |
|---|---|---|
| 학습자 | `/review` 수업 목록 · `/review/[회차]` 복습 순서 · `/review/[회차]/transcript` 강의 기록 전체 | 앱에서 초대 링크와 구글 로그인 |
