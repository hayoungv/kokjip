...
- [x] T7 | CORE  | 개인정보와 저작권 운영 규칙의 확정 수준 | depends:T3       | status:RESOLVED | decision:질의응답 포함 전사·강사 외 화자는 무기명 단일 표시·전사본 과정 종료 후 1년 보관 | applied:docs/00-plan/product-decisions.md, AGENTS.md §5-8
