...
RESOLVED: 9 / DROPPED: 0 / TOTAL: 10 (2회차)
...
- [x] S7 | CORE  | 확정 기술 스택과 금지 스택 | depends:S1,S2,S3,S4,S6 | status:RESOLVED | decision:Next.js 단일 풀스택 + React Native(Expo) 앱, 녹음·기기전사만 네이티브 조각, Claude 묶음 호출 | applied:docs/00-plan/product-decisions.md, AGENTS.md §6-10 | note:aztks apply로 결정
