...
|---|---|---|---|
| 학습자 | 안드로이드 앱 | 초대 링크로 앱을 열고 구글 계정으로 로그인 | 녹음, 올리기, 복습 목록 보기, 다시 듣기, 강의 기록 보기 |
...
**내용** 제품이 강사에게 전용 주소가 담긴 안내를 보낸다. 강사는 그 주소를 열어 동의한다. 동의할 때 무엇을 녹음하도록 허용하는지, 녹음에서 무엇을 글로 옮기는지, 강의 기록을 언제까지 보관하는지, 특정 회차를 막을 수 있다는 것을 함께 보여준다.
...
**내용** 강의 기록에서 강사가 강조한 말을 찾아 유형과 강도와 강사의 말과 실제 시각을 낸다.
...
**내용** 그날 찾아낸 말을 하루에 하나의 목록으로 보여준다. 강도가 높은 것을 먼저 보여준다.
...
| 녹음 | 한 회차 안에서 녹음이 끊긴 단위로 나뉜 각각의 녹음 |
