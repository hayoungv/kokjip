...
| 알림 | 안드로이드 푸시 알림 |
| 문자 발송 | 국내 문자 발송 공급자 (미정) |
| 테스트 | Vitest, Playwright, 안드로이드 계측 테스트 |
| 인프라 | Vercel과 Supabase, 유료 구간 허용 |
...
| 문자 발송 창구 | 학습자 본인 확인에 쓰는 문자를 보낸다 |
...
|---|---|---|---|
| 학습자 | 안드로이드 앱 | 초대 링크로 앱을 열고 휴대폰 번호로 본인 확인 | 녹음, 올리기, 복습 목록 보기, 다시 듣기, 옮긴 글 보기 |
...
- 초대 명단에 있는 휴대폰 번호로 확인한 사람만 들어온다.
...
| 학습자 | 이름과 휴대폰 번호 |
| 강사 | 이름과 연락처, 전용 주소와 그 유효 기간 |
| 녹음허용 | 강사가 동의한 시각과 동의한 범위 |
| 차단 | 강사가 닫은 회차 |
| 녹음조각 | 올린 학습자, 시작과 종료 실제 시각, 중단 구간, 정본 여부 |
| 옮긴글 | 조각에서 나온 글과 블록별 실제 시각 |
| 강조한대목 | 유형, 강사의 말, 실제 시각 |
...
## REQ-FUNC-003 학습자 계정 생성과 본인 확인

**근거** 제품 요구사항 정의서 3 · 착수 전 결정 T1 · S6

**내용** 학습자가 초대 링크로 앱을 열고 휴대폰 번호로 본인을 확인한다. 초대 명단에 있는 번호로 확인한 사람만 들어온다.

**수용 기준**

- 초대 명단에 없는 번호로는 확인이 완료되지 않는다.
- 확인이 끝나면 그 학습자가 해당 과정에 속한 것으로 기록된다.
- 앱을 지우고 다시 깔아도 같은 번호로 계정을 되찾는다.
...
**내용** 앱이 강의 중에 직접 녹음하면서 같은 기기 안에서 글로 옮긴다. 기기 안 처리를 강제하는 호출만 쓴다.

**수용 기준**

- 녹음을 시작하기 전에 그 회차가 열림인지 확인한다. 닫혀 있으면 녹음 버튼이 열리지 않는다.
- 녹음과 전사가 동시에 진행되어 녹음이 끝나는 시점에 옮긴 글이 함께 완성된다.
...
**내용** 옮긴 글에서 강사가 강조한 대목을 찾아 유형과 강사의 말과 실제 시각을 낸다.

**수용 기준**

- 판정을 묶음으로 보낸다.
- 찾는 대상은 강사의 말뿐이다. 수강생 발언은 판정 대상이 아니다.
...
**내용** 그날 찾아낸 대목을 하루에 하나의 목록으로 보여준다.

**수용 기준**

- 목록은 하루에 하나다. 조각마다 목록이 나뉘지 않는다.
- 조각이 처리될 때마다 같은 목록에 시각 순으로 더해진다.
- 각 줄에 유형, 강사의 말, 시각이 보인다.
- 목록이 준비되면 학습자에게 알린다.
...
- 강사의 말과 수강생의 말이 구분되어 보인다.
- 강사가 아닌 사람은 모두 수강생이라는 한 가지 이름으로만 표시된다.
...
- 기기 전용 인식기를 지원하는 안드로이드 판 이상에서 동작한다.
...
**내용** 강사가 아닌 사람은 모두 수강생이라는 한 가지 이름으로만 표시한다.

**수용 기준**

- 화자에게 번호나 식별자를 붙이지 않는다.
...
| REQ-FUNC-003 | 학습자 계정 생성과 본인 확인 | 2 |
