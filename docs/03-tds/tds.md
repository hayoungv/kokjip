...
| 창구 | 하는 일 | 관련 요구사항 |
|---|---|---|
| 초대 확인 | 초대 링크의 값과 휴대폰 번호를 받아 본인 확인을 시작한다 | REQ-FUNC-003 |
| 본인 확인 완료 | 문자로 받은 숫자를 확인하고 계정을 만든다 | REQ-FUNC-003 |
...
| 학습자 본인 확인 | 초대 명단의 번호와 일치할 때만 확인을 진행한다. 명단에 없는 번호는 확인 자체가 시작되지 않는다 |
