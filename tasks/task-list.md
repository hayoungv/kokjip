...
- 묶음 제출과 상태 확인과 결과 수거
- 결과를 찾아낸 말으로 저장하고 덮인 범위를 갱신한다
- 같은 말이 두 번 들어와도 겹쳐 쌓이지 않게 한다
- 쓴 토큰과 비용 기록, 한 사람당 값 계산
- 보관 기간이 지난 강의 기록 삭제, 24시간을 넘긴 음성 삭제
...
- 하루에 하나의 목록에 녹음 결과가 강도 높은 순으로 더해진다
...
- 닫힌 녹음을 넘겨 전사하고 다음 녹음과 겹쳐 돌린다
- 실패한 녹음을 예외 경로로 넘기는 처리

**만족하는 요구사항** REQ-FUNC-004의 전사 부분, REQ-FUNC-005, REQ-NF-003

**완료 기준**
- 비행기 모드에서 전사가 동작한다.
- 앞 녹음의 전사가 뒤 녹음의 녹음과 겹쳐 진행된다.
- 녹음을 멈춘 뒤 마지막 녹음의 길이를 넘는 대기가 생기지 않는다.
